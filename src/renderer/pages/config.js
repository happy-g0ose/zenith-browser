...
const prefMeta = {
  ...
  'privacy.shield.dnt_header': { ru: 'Заголовок Do Not Track (DNT)', en: 'Do Not Track (DNT) Header', desc_ru: 'Передаёт сайтам сигнал о запрете отслеживания', desc_en: 'Sends DNT header requesting sites not to track user' },
  'privacy.shield.gpc_header': { ru: 'Заголовок Global Privacy Control (GPC)', en: 'Global Privacy Control Header', desc_ru: 'Юридический сигнал запрета на продажу персональных данных', desc_en: 'Sends GPC header asserting data privacy rights' },
